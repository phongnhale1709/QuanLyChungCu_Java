 ...
 * @author hyn09
 */
 public class Maincudan extends javax.swing.JFrame {
    ...
    public Maincudan(TTDangNhapModel t) {
        initComponents();
        ...
        public void mousePressed(java.awt.event.MouseEvent evt) {
            ...
            jframettcn.setBackground(new Color(125,125,125));
        ...
        public void mouseEntered(java.awt.event.MouseEvent evt) {
            ...
            jframettcn.setBackground(new Color(255, 255, 255));
        }

        @Override
        public void mouseExited(java.awt.event.MouseEvent evt) {
                jfr.setBackground(new Color(152,205,205));
                jframettcn.setBackground(new Color(152,205,205));
        ...
        public void mousePressed(java.awt.event.MouseEvent evt) {
            ...
            jframetthd.setBackground(new Color(125,125,125));
        ...
        public void mouseEntered(java.awt.event.MouseEvent evt) {
            ...
            jframetthd.setBackground(new Color(255, 255, 255));
        }

        @Override
        public void mouseExited(java.awt.event.MouseEvent evt) {
                jpn.setBackground(new Color(152,205,205));
                jframetthd.setBackground(new Color(152,205,205));
        ...
        public void mousePressed(java.awt.event.MouseEvent evt) {
            ...
            jlbguiyc.setBackground(new Color(125,125,125));
        ...
        public void mouseEntered(java.awt.event.MouseEvent evt) {
            ...
            jlbguiyc.setBackground(new Color(255, 255, 255));
        }

        @Override
        public void mouseExited(java.awt.event.MouseEvent evt) {
                jpnNhapHang.setBackground(new Color(152,205,205));
                jlbguiyc.setBackground(new Color(152,205,205));
    ...
    private void initComponents() {
        ...
        jframettcn = new javax.swing.JLabel();
        jpn = new javax.swing.JPanel();
        jframetthd = new javax.swing.JLabel();
        jpnNhapHang = new javax.swing.JPanel();
        jlbguiyc = new javax.swing.JLabel();
        ...
        jframettcn.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jframettcn.setText("THÔNG TIN CÁ NHÂN");
        ...
        jframetthd.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jframetthd.setText("THÔNG TIN HOÁ ĐƠN");
        ...
        jlbguiyc.setFont(new java.awt.Font("Arial", 1, 16)); // NOI18N
        jlbguiyc.setText("GỬI YÊU CẦU");
    ...
    private javax.swing.JLabel jframettcn;
    private javax.swing.JLabel jframetthd;
    private javax.swing.JLabel jlbTrangChu;
    private javax.swing.JLabel jlbguiyc;
