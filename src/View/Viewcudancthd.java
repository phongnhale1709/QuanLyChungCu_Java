...
import View.Viewthongtinhoadon;
...
public class Viewcudancthd extends javax.swing.JFrame {
    String ma="";
    public Viewcudancthd() {
        super();
        initComponents();
    ...
    public Viewcudancthd(String ma) {
        initComponents();
        setLocationRelativeTo(null);
        this.ma = ma ;
        ...
        try {
            ...
            Logger.getLogger(Viewcudancthd.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Viewcudancthd.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Viewcudancthd().setVisible(true);
            }
        });
    }
